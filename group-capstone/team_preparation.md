...
- Follows text written requirements (e.g., user stories)
...
This is the first time at Microverse when you build a project in a group. 
...
### Why preparation as a team is important?


Before you start splitting the work and coding, all must understand the task that is ahead of you.
...
_All links above are the lessons that you have already completed._
...
As for group projects, you will get code reviews from your teammates and from external Code Reviewers; make sure that you understand this flow described in [this article](https://github.com/microverseinc/curriculum-transversal-skills/blob/main/code-review/articles/code_review_flow_group_projects.md).


### Project requirements

- Now, it's time to read [the project requirements](https://github.com/microverseinc/curriculum-javascript/tree/main/group-capstone/js_capstone.md). Treat it as a Sneak Peek and make sure that everybody in your team understands the challenge.
